...
const songs=[
    ...
    {
        id: 9,
        songName: `Duniya Jalaa Denga<br>
    ...
    {
        id: 15,
        songName: `Okay Not To Be Okay<br>
        <div class="subtitle">Calvin Sparks</div>`,
        poster: "img/15.jpg"
    },
    {
        id: 16,
    ...
    },
    {
        ...
        <div class="subtitle">Denial Lavi</div>`,
        poster: "img/17.jpg"
    },
    {
        id: 18,
        songName: `Falling<br>
        <div class="subtitle">Trevor Denial</div>`,
        poster: "img/18.jpg"
    },
    {
        id: 19,
        songName: `Kina - Can We Kiss Forever?<br>
        <div class="subtitle">Adriana Proenza</div>`,
        poster: "img/19.jpg"
    },
    {
        id: 20,
...
Array.from(document.getElementsByClassName('playlist_play')).forEach((e) =>{
    e.addEventListener('click', (el) =>{
        ...
        //console.log(download_music.href);
